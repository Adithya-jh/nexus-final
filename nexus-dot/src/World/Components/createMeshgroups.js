import { BoxGeometry ,Mesh, MeshStandardMaterial,MathUtils,SphereGeometry ,TextureLoader, Group,SphereBufferGeometry, ShaderMaterial,
 BoxBufferGeometry, Clock, PlaneBufferGeometry , DoubleSide, Points,PointsMaterial, AdditiveBlending} from "three";
...
function createBlob(){
    ...
    const blob = new Points(sphereGeometry, sphereMaterial)
    blob.position.z=0
    blob.position.x=-12.5
    blob.position.y=4
...
export { createCube , createSphere, createBlob,createBlob2, createBackground};